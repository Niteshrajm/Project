...
public class Category extends javax.swing.JFrame {
        ...
        if (ri != -1) {
            try {
                ...
                if (r == JOptionPane.YES_OPTION) {
                    ...
                    db.DbConnection.st.executeUpdate("delete from category_info where category = '" + category + "'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (!category.equals("")) {
                db.DbConnection.st.executeUpdate("insert into category_info values ('" + category + "')");
